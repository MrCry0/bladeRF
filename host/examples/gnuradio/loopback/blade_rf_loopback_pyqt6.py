...
# Patched: PyQt6-compatible and fully self-contained
##################################################
...
# Qt and GNU Radio imports
from PyQt6 import QtCore, QtGui
from PyQt6.QtCore import QSettings
from PyQt6.QtWidgets import QApplication, QWidget, QVBoxLayout, QLabel, QScrollArea, QTabWidget, QGridLayout, QComboBox, QFrame
from gnuradio import qtgui, gr, blocks, analog, filter, uhd
from gnuradio.qtgui import Range, RangeWidget
import sip

class bladeRF_loopback(gr.top_block, QWidget):
    def __init__(self, instance=0, loopback="bb_txvga1_rxlpf", rx_bandwidth=1.5e6, rx_buflen=4096, rx_frequency=915e6, rx_lna_gain=6, rx_num_buffers=16, rx_num_xfers=8, rx_sample_rate=3e6, rx_vga_gain=20, serial="", tx_bandwidth=1.5e6, tx_buflen=4096, tx_frequency=915e6, tx_num_buffers=16, tx_num_xfers=8, tx_sample_rate=3e6, tx_vga1=-18, tx_vga2=0, verbosity="info"):
        ...
        self.top_scroll.setFrameStyle(QFrame.Shape.NoFrame)
        ...
        self.bladerf_tx_args = bladerf_tx_args = "bladerf=" + bladerf_selection + ",buffers=" + str(tx_num_buffers) + ",buflen=" + str(self.get_tx_buflen()) + ",num_xfers=" + str(tx_num_xfers) + ",verbosity="+verbosity
        self.bladerf_rx_args = bladerf_rx_args = "bladerf=" + bladerf_selection + ",loopback=" + loopback + ",buffers=" + str(rx_num_buffers) + ",buflen=" + str(self.get_rx_buflen()) + ",num_xfers=" + str(rx_num_xfers) + ",verbosity="+verbosity
        ...
        self.tabs_widget_0 = QWidget()
        self.tabs_layout_0 = QVBoxLayout(self.tabs_widget_0)
        self.tabs_grid_layout_0 = QGridLayout()
        self.tabs_layout_0.addLayout(self.tabs_grid_layout_0)
        self.tabs.addTab(self.tabs_widget_0, "RX")
        self.tabs_widget_1 = QWidget()
        self.tabs_layout_1 = QVBoxLayout(self.tabs_widget_1)
        self.tabs_grid_layout_1 = QGridLayout()
        ...
        self._gui_rx_lna_gain_tool_bar = QToolBar(self)
        self._gui_rx_lna_gain_tool_bar.addWidget(QLabel("LNA Gain"+": "))
        self._gui_rx_lna_gain_combo_box = QComboBox()
        ...
        self._gui_rx_lna_gain_callback = lambda i: self._gui_rx_lna_gain_combo_box.setCurrentIndex(self._gui_rx_lna_gain_options.index(i))
        ...
        self._qtgui_waterfall_sink_x_0_0_win = sip.wrapinstance(self.qtgui_waterfall_sink_x_0_0.pyqwidget(), QtWidgets.QWidget)
        ...
        self._qtgui_waterfall_sink_x_0_win = sip.wrapinstance(self.qtgui_waterfall_sink_x_0.pyqwidget(), QtWidgets.QWidget)
        ...
        self._qtgui_time_sink_x_0_0_win = sip.wrapinstance(self.qtgui_time_sink_x_0_0.pyqwidget(), QtWidgets.QWidget)
        ...
        self._qtgui_time_sink_x_0_win = sip.wrapinstance(self.qtgui_time_sink_x_0.pyqwidget(), QtWidgets.QWidget)
        ...
        self._qtgui_freq_sink_x_0_0_win = sip.wrapinstance(self.qtgui_freq_sink_x_0_0.pyqwidget(), QtWidgets.QWidget)
        ...
        self._qtgui_freq_sink_x_0_win = sip.wrapinstance(self.qtgui_freq_sink_x_0.pyqwidget(), QtWidgets.QWidget)
        ...
        self._gui_bladerf_tx_args_tool_bar = QToolBar(self)
        ...
        self._gui_bladerf_tx_args_tool_bar.addWidget(QLabel("bladeRF TX arguments"+": "))
        self._gui_bladerf_tx_args_label = QLabel(str(self._gui_bladerf_tx_args_formatter(self.gui_bladerf_tx_args)))
        ...
        self._gui_bladerf_rx_args_tool_bar = QToolBar(self)
        ...
        self._gui_bladerf_rx_args_tool_bar.addWidget(QLabel("bladeRF RX arguments"+": "))
        self._gui_bladerf_rx_args_label = QLabel(str(self._gui_bladerf_rx_args_formatter(self.gui_bladerf_rx_args)))
    ...
    def set_gui_bladerf_tx_args(self, gui_bladerf_tx_args):
        ...
        self._gui_bladerf_tx_args_label.setText(str(self.gui_bladerf_tx_args))
    ...
    def set_gui_bladerf_rx_args(self, gui_bladerf_rx_args):
        ...
        self._gui_bladerf_rx_args_label.setText(str(self.gui_bladerf_rx_args))
        # Add more blocks and connections as needed here...
        # e.g., SDR source/sink, loopback config, etc.
